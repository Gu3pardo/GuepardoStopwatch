...
public class FloatingService extends Service {
    ...
    public void onCreate() {
        ...
        _bubblePosY = (int) _sharedPrefController.load(Constants.bubblePosY, Constants.bubbleDefaultPosY);
        ...
        _bubble.setOnClickListener(view -> {
            if (_movedBubble) {
                _movedBubble = false;
                params.x = 0;
                _bubblePosY = params.y;

                _sharedPrefController.save(Constants.bubblePosY, _bubblePosY);
    ...
    private void showStopwatch() {
        ...
        FloatingActionButton btnAbout = _stopwatchView.findViewById(R.id.btnImpressum);
